...
describe('vehicle purchase', () => {
  ...
  describe('chooseVehicle', () => {
    ...
    test('correctly recommends the right option with near same names', () => {
      expect(chooseVehicle('Volkswagen Beetle', 'Volkswagen Beatle')).toBe(
        'Volkswagen Beatle' + rest
      );
      expect(chooseVehicle('2020 Volkswagen Baatle', '2018 Volkswagen Beetle')).toBe(
        '2018 Volkswagen Beetle' + rest
      );
    });
  });
